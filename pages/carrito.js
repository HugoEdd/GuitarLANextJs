...
// primero y muy importante extraemos el carrito
export default function Carrito({carrito, actualizarCantidad, eliminarProducto}) {

    const [total, setTotal] = useState(0);  

    // utilizaremos un arrayMethod para esto, es util para este tipo de operaciones, en el cual quiere calcular el acumulado de un arreglo
    useEffect(() => {
    ...
    <Layout title='Carrito de Compras'>
          <main className='contenedor'>
              ...
              <div className={styles.contenido}>
                {/* En este div vamos a aplicar el display de grid */}
